...
class _MotoCrudScreenState extends State<MotoCrudScreen> {
  final CollectionReference _motosCollection =
      FirebaseFirestore.instance.collection('motos');

  Future<void> _showMotoDialog({Moto? moto}) async {
                  ...
                  child: Row(
                    children: [
                      Container(
                        ...
                        child: Icon( isEditing ? Icons.edit_rounded : Icons.add_rounded, color: Colors.white, size: 24,),
                      ),
                          ...
                          onPressed: () async {
                            ...
                            if (model.isNotEmpty) {
                              try {
                                ...
                                if (isEditing) {
                                  await _motosCollection.doc(moto.id).update(motoData);
                                } else {
                                  await _motosCollection.add(motoData);
                                }
  ...
  Future<void> _deleteMoto(String id) async {
    ...
    if (confirmed == true) {
      try {
        await _motosCollection.doc(id).delete();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: _motosCollection.orderBy('model').snapshots(),
        builder: (context, snapshot) {
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    ...
                    style: TextStyle(color: textDark, fontSize: 18, fontWeight: FontWeight.w600),
                  ),
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              final moto = Moto.fromFirestore(
                motoDocs[index] as DocumentSnapshot<Map<String, dynamic>>,
              );
  ...
  Widget _buildMotoCard(Moto moto) {
    return Container(
              ...
              children: [
                Row(
                  children: [
                    ...
                    IconButton(
                      icon: const Icon(Icons.edit_rounded, color: primaryGreen, size: 22),
